...
test('should highlight content in HTML', () => {
  ...
  // Remove HTML tags from the expected and received output for accurate comparison
  const expectedOutputWithoutHTML = removeHTMLTags(expectedOutput);
  const receivedOutputWithoutHTML = removeHTMLTags(receivedOutput);

  expect(receivedOutputWithoutHTML).toEqual(expectedOutputWithoutHTML);
});
